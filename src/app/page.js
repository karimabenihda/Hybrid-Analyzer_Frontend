    ...
    <>
      ...
      />
        ...
        <div className="flex items-center gap-3">
          <a href="/auth/login">
          <button className="hidden md:block px-6 py-2.5 bg-purple-600 hover:bg-purple-700 active:scale-95 transition-all rounded-full text-sm">
            Login         
          </button>
          </a>
          <button className="hidden md:block px-6 py-2.5 bg-white text-purple-600 hover:bg-gray-100  active:scale-95 transition-all rounded-full text-sm">
Register          </button>

          <button
            aria-label="Open menu"
            onClick={() => setMenuOpen(true)}
            className="md:hidden active:scale-90 transition p-2"
          >
